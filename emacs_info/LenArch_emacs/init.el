...
;; clean aesthetically-pleasing mode line (status) bar. 2026-05-28 
;; failed when I M-x eval-buffer
...
;; ----------------------------------------------------------------------------------------------
;; doom-modeline installed 2026-05-28k
...
(when (member "Roboto Mono" (font-family-list))
  ...
  (set-face-attribute 'default nil :font "Roboto Mono" :height 175)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(corfu dired-subtree doom-modeline doom-themes evil-escape ivy magit
	   marginalia markdown-mode orderless org-bullets
	   org-superstar treemacs vertico which-key)))
(custom-set-faces
